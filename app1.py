...
def extract_raw_lines(uploaded_pdf):
    ...
    return all_lines
# ==========================================================
# GPT EXTRACTOR — Enhanced Document Number Detection
# ==========================================================
def extract_with_gpt(lines):
    """Use GPT to detect Debit (DEBE) and Credit (HABER) from vendor statements with precise document detection."""
    BATCH_SIZE = 150
    all_records = []
...
3. **Credit Note**: Contains "NC", "Nota Credito", "Ακυρωτικό", "Πιστωτικό", "Abono" → put in Credit
